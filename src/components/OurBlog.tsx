...
export const WorkMethodCard = ({
  ...
  return (
    <Box w="full">
      <Image src={imagePath} />
      <Heading fontSize={20} color="#273B4A">
        {heading}
      </Heading>
      <Text textAlign={"justify"} color="#273B4A">
        {description}
      </Text>
    </Box>
  );
