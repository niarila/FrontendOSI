...
// import {Box, Container, Heading, SimpleGrid, Text, Grid, Link, Button } from "@chakra-ui/react"
...
//         <SimpleGrid spacing='30px' py='30px' templateColumns='repeat(2, 1fr)'>
//           <Box>
//             <Heading pb='15px' color='#FFFFFF'>Get in Touch</Heading>
...
//             admin@oemahsolution.com
//             </Button>
//             <Text>Ruko DTA (Down Town Area) Square,
// Jl. Seturan Raya No. 9, Kledokan, Caturtunggal, Kec. Depok,
// Kabupaten Sleman, Daerah Istimewa Yogyakarta 55281</Text>
//             <Button bg='#FFB703'>
//             Show Map
//             </Button>
...
//             <Heading color='#FFFFFF'>Let’s Collaborate with Us</Heading>
//             <Grid pt='30px'>
//               <Text color='#F4F4F4' textAlign={'justify'}>Every great work is started from a nice conversation and a cup of coffee.
// Share your business problem with us and let us be part of the solution,
// because we are Oemah Solution. Feel free to meet us in our office.</Text>
//             </Grid>
//           </Box>
//         </SimpleGrid>
//       </Container>
...
//           <Text>Copyright © 2023 All right reserved. PT. Oemah Solution Indonesia</Text>
//           <Stack direction={'row'} spacing={6}>
